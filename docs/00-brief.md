I'm solo developer and want to design and assembly kitchen cabinets for Wroclaw's customers. I'm going to develop and integrate set of apps to be able to fulfill such usecase:

Use case: First visit

1.  I visit customer with at this new investment with decors from Kronospan, Egger.
2.  I measure the kitchen space and make notes
3.  To help customer choose the initial material I open web app "kitchen-app"
4.  A few predefined 2.5D kitchen layouts popup
5.  I chose one
...
1. I open second app “kitchen-plugin“
...
8. System send rows and cabinets configuration with decor names to backend using intermediate format (not CAD ready)
