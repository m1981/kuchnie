# 📚 SYSTEM PLAYBOOKÓW - CZĘŚĆ 2: MONTAŻ

Kontynuacja z PLAYBOOK_SYSTEM.md
...
### ⚠️ ZASADY FUNDAMENTALNE (przeczytaj 3 RAZY!)

```
🔴 REGUŁA #1: Blat HPL to NIE płyta wiórowa!
   → Rdzeń z żywicy fenolowej - twardy jak kamień
   → Zwykła tarcza do drewna go NIE przetnie (spali się!)

🔴 REGUŁA #2: Nigdy OSTRYCH KĄTÓW 90°!
   → Każdy narożnik otworu (zlew, płyta) = ZAOKRĄGLONY!
   → Promień min. 5mm (wiertło 10mm w narożnikach)

🔴 REGUŁA #3: Blat musi "oddychać"!
   → NIE przykręcać na sztywno!
   → Tylko klej elastyczny punktowo

🔴 REGUŁA #4: Transportuj TYLKO W PIONIE!
   → Poziomo się zarysuje od siebie
```

---

### 🔧 KROK 1: Narzędzia i materiały (przygotuj PRZED rozpoczęciem)

```
NARZĘDZIA:
☐ Zagłębiarka + szyna prowadząca (najważniejsze!)
☐ Tarcza HM do laminatów - 60+ zębów (np. Bosch Expert)
☐ Frezarka + frez 6mm, 8mm
☐ Wiertarka + wiertła: 5mm, 8mm, 10mm
☐ Wiertło Forstner 35mm (jeśli zlew wpuszczany)
☐ Otwornica 68mm (pod baterie jeśli montuje)
☐ Dalmierz laserowy (pomiary precyzyjne)
☐ Kątownik stalowy 30cm
☐ Miara zwijana 5m
☐ Poziomica 60cm
☐ Ołówek + gumka
☐ Taśma malarska (ochrona dekoru przy cięciu)
☐ Odkurzacz (kurz z cięcia HPL jest WSZĘDZIE!)

MATERIAŁY:
☐ Blat HPL 12mm (docięty do szerokości ± zapas)
☐ Klej Ottocoll M500 (2 tuby)
☐ Osłona termiczna samoprzylepna (pod płytę indukcyjną)
☐ Silikon bezbarwny (uszczelnienie styku ze ścianą)
☐ Ściereczki mikrofibr (czyszczenie)
☐ Papier ścierny 120 (wygładzenie krawędzi)

INSTRUKCJE AGD (KONIECZNIE!):
☐ Instrukcja montażu zlewozmywaka (wymiary wycięcia!)
☐ Instrukcja montażu płyty indukcyjnej (wymiary wycięcia!)
```

---

### 📏 KROK 2: Aklimatyzacja blatu (30 min przed cięciem)

```
☐ Jeśli blat był w zimnym magazynie / aucie:
...
### ✂️ KROK 3: Pomiar i oznaczenie cięć (PRECYZJA!)

```
☐ Pomiar DŁUGOŚCI blatu:
   ☐ Zmierz szerokość szafek dolnych (cała linia)
...
☐ Oznaczenie linii cięcia NA SPODZIE blatu:
   ☐ Połóż blat SPODEM DO GÓRY na szafkach / stole
   ☐ Odmierz wymiary dalmierzem
   ☐ Zaznacz linię OŁÓWKIEM (dobrze widoczna!)
   ☐ Naklej TAŚMĘ MALARSKĄ wzdłuż linii cięcia
      → Chroni dekor przed wyszczerbieniem

🔴 ZASADA CIĘCIA HPL:
   → ZAWSZE tnij DEKOREM DO GÓRY! (piękna strona górą)
   → Tarcza wchodzi od góry - wyrzuca wióry w dół (spód)
   → Dzięki temu dekór pozostaje idealnie gładki
```

---

### 🪚 KROK 4: Cięcie blatu zagłębiarką

```
☐ Montaż tarczy HM do laminatów (60+ zębów):
   ☐ Sprawdź kierunek montażu (strzałka na tarczy!)
   ☐ Dokręć mocno klucz

☐ Ustawienie głębokości cięcia:
   ☐ Głębokość = grubość blatu + 2mm
   ☐ Dla blatu 12mm → ustaw 14mm

☐ Montaż szyny prowadzącej:
   ☐ Ustaw szynę równolegle do linii cięcia
   ☐ Sprawdź odległość: od krawędzi podstawy zagłębiarki do brzeszczotu
   ☐ Przykręć szynę za pomocą klamer (lub użyj ciężarów)

☐ CIĘCIE (WOLNO I SPOKOJNIE!):
   ☐ Włącz odkurzacz (podłącz do zagłębiarki)
   ☐ Włącz zagłębiarkę - niech nabierze obrotów (10 sek)
   ☐ Prowadź WOLNO wzdłuż szyny (nie forsuj!)
   ☐ Nie zatrzymuj się w połowie cięcia (równomierny ruch)
   ☐ Na końcu cięcia - lekko zwolnij (unikniesz wyrwania)

☐ Sprawdzenie cięcia:
   ☐ Oderwij taśmę malarską
   ☐ Sprawdź czy krawędź gładka (bez wyszczerbień)
   ☐ Jeśli drobne nierówności: papier ścierny 120
```

---

### 🔴 KROK 5: WYCIĘCIE OTWORU POD ZLEW (SUPER WAŻNE!)

⚠️ **TO NAJTRUDNIEJSZY MOMENT - BŁĄD = PĘKNIĘTY BLAT = 600zł STRATY!**
...
☐ Wyznaczenie pozycji wycięcia:
   ...
   ☐ PRZYKŁAD:
      ...
      → Centrum zlewu = 30cm od przodu
      → Krawędź przednia wycięcia = min. 5cm od krawędzi blatu ✓

☐ Zaznaczenie wycięcia:
   ☐ Położenie blatu SPODEM DO GÓRY
   ☐ Przyłożenie szablonu zlewu (lub ręczne wymierzenie)
   ☐ Obrysowanie ołówkiem
...
☐ Wyciągnięcie wyciętego kawałka:
   ☐ Delikatnie podważ i wyjmij środek
   ☐ Sprawdź czy krawędzie są gładkie
   ☐ Jeśli szorstkie: papier ścierny 120

☐ Zabezpieczenie krawędzi wycięcia:
   ☐ Silikonem bezbarwnym (cienko!)
   ☐ Zapobiega wnikaniu wilgoci do rdzenia
```

---

### 🔥 KROK 6: WYCIĘCIE OTWORU POD PŁYTĘ INDUKCYJNĄ

```
☐ Przygotowanie:
   ☐ Otwórz instrukcję montażu płyty indukcyjnej
   ☐ Sprawdź wymiary wycięcia (np. 560 x 490 mm)
...
☐ Zaznaczenie wycięcia:
   ☐ Blat SPODEM DO GÓRY
   ☐ Szablon płyty lub ręczne wymiary
   ☐ Obrysowanie ołówkiem
   ☐ Weryfikacja 2x!

☐ 🔴 WIERCENIE NAROŻNIKÓW:
   ☐ Wiertło 10mm
   ☐ 4 narożniki prostokąta
   ☐ Wiercenie od SPODU (dekor w dół)
   ☐ Powoli!

☐ Połączenie narożników:
   ☐ Frezarka lub zagłębiarka (j.w. jak przy zlewie)
   ☐ Gładkie krawędzie
...
☐ 🔴 ZABEZPIECZENIE TERMICZNE (KONIECZNIE!):
   ...
   ☐ Montaż płyty indukcyjnej:
      ...
      ☐ Uszczelka sucha (z kompletu płyty) między płytą a blatem
```

---

### 🔩 KROK 7: Montaż trawersów metalowych POD blatem

```
☐ Gdzie montować:
   ☐ Szafka pod zlewem (koniecznie!)
   ☐ Szafka pod płytą indukcyjną (koniecznie!)
   ☐ Szafki szerokie >80cm (opcjonalnie, dla stabilności)

☐ Montaż trawersów:
   ☐ Trawersy Egger (600mm, 800mm, 1000mm - wg szerokości szafki)
   ☐ Przykręcenie do boków korpusu szafki (śruby z kompletu)
   ☐ Nawierty w bokach korpusu (jeśli CNC zrobiło - gotowe!)
   ☐ Jeśli brak nawiertu: wywierć otwory wg instrukcji Egger (Rys. 51, 52)

☐ Sprawdzenie:
   ☐ Czy trawersy są w poziomie? (poziomica)
   ☐ Czy mocno przykręcone? (nie chwieje się)
```

---

### 🧴 KROK 8: Klejenie blatu do korpusów

```
🔴 ZASADA: NIE przykręcaj blatu na sztywno!
   → Blat HPL rozszerza się pod wpływem wilgoci i temp.
   → Sztywne przykręcenie = pęknięcia!
   → Rozwiązanie: klej elastyczny PUNKTOWO

☐ Przygotowanie:
   ☐ Korpusy dolne ustawione i wypoziomowane (z Playbook #08)
   ☐ Trawersy zamontowane
   ☐ Blat wycięty i gotowy

☐ Nakładanie kleju Ottocoll M500:
   ☐ Otwórz tubę, załóż na pistolet
   ☐ Nałóż KROPELKI kleju (wielkość orzecha włoskiego)
   ☐ Rozstaw: co 30-40 cm na trawersy / wieńce
   ☐ NIE SMARUJ ciągłą warstwą! (musi być elastycznie)

☐ Położenie blatu:
   ☐ Dwie osoby podnoszą blat (ciężki - 20-30kg!)
   ☐ Ustawienie blatu na szafkach (dokładnie!)
   ☐ Sprawdzenie występu z przodu: 3-4cm (równo!)
   ☐ Sprawdzenie czy blat przy ścianie (tył)

☐ Dociśnięcie:
   ☐ Dociśnij blat do korpusów (ręką na całej długości)
   ☐ Połóż obciążniki (np. wiaderka z wodą) w miejscach kleju
   ☐ Odczekaj 2 godziny (klej twardnieje!)

⚠️ Przez te 2 godz. możesz montować fronty, szuflady (Playbook #08 cd.)
```

---

### 🚰 KROK 9: Montaż zlewozmywaka

#### Opcja A: Zlew PODWIESZANY (nowoczesny, elegancki)

```
☐ Zestaw montażowy Egger (listwy klejone):
   ☐ Przyłóż listwy mocujące do spodu blatu (wokół wycięcia)
   ☐ Zaznacz pozycję ołówkiem
   ☐ Odtłuść powierzchnię (alkohol izopropylowy)
   ☐ Naklej listwy (mocny klej z zestawu Egger)
   ☐ Dociśnij ściskami / obciążnikami
   ☐ Odczekaj 24h! (klej musi stwardnieć)

☐ Następnego dnia - montaż zlewu:
   ☐ Nasadź zlew na listwy od dołu
   ☐ Dokręć śruby mocujące (w komplecie)
   ☐ Sprawdź czy zlew w poziomie
   ☐ Uszczelnij styk silikon sanitarny (cienka warstwa!)

☐ Podłączenie instalacji:
   ☐ Syfon (sprawdź szczelność!)
   ☐ Bateria (uszczelki gumowe!)
   ☐ Test: Odkręć wodę → Czy nie cieknie?
```

#### Opcja B: Zlew WPUSZCZANY (tańszy, szybszy)

```
☐ Nałożenie silikonu:
   ☐ Wokół krawędzi zlewu (pasek ciągły)
   ☐ Silikon sanitarny bezbarwny

☐ Wpuszczenie zlewu w otwór:
   ☐ Od góry blatu
   ☐ Dociśnij mocno (silikon wyciska się)
   ☐ Przymocuj klamrami montażowymi (z kompletu zlewu)
   ☐ Dokręć śruby klamr od spodu

☐ Usunięcie nadmiaru silikonu:
   ☐ Ściereczką mikrofibr (od razu, póki mokry!)

☐ Podłączenie instalacji (j.w.)
```

---

### 🪟 KROK 10: Montaż panelu ściennego HPL (splashback)

```
☐ Pomiar przestrzeni:
   ☐ Wysokość od blatu do spodu szafek górnych: ____ cm
   ☐ Długość (taka jak blat): ____ cm

☐ Docięcie płyty HPL 10mm:
   ☐ Zagłębiarką (j.w. jak przy blacie)
   ☐ Tarcza HM do laminatów
   ☐ Dekorem do góry!

☐ 🔴 Wycięcie otworów na gniazdka:
   ☐ Zmierz pozycję gniazdek (od lewej, od dołu)
   ☐ Zaznacz na panelu
   ☐ Otwornica 68mm (standard gniazdka podtynkowe)
   ☐ Wiercenie WOLNO (od frontu panelu!)
   ☐ Sprawdź czy gniazdko wpasowuje się idealnie

☐ Przyklejenie panelu do ściany:
   ☐ Klej montażowy (np. Mamut, Ottocoll)
   ☐ Nałóż PUNKTOWO na tył panelu (co 30cm)
   ☐ Przyciśnij panel do ściany
   ☐ Podeprzyjstolarz (kawałki drewna od podłogi)
   ☐ Odczekaj 12-24h

☐ Uszczelnienie styku z blatem:
   ☐ Silikon bezbarwny (cienka linia)
   ☐ Wygładź palcem (rękawiczka!)
   ☐ Usuń nadmiar ściereczką
```

---

### ✅ KROK 11: Kontrola końcowa i czyszczenie

```
☐ Sprawdzenie wszystkich cięć:
   ☐ Czy krawędzie gładkie? (bez wyszczerbień)
   ☐ Czy blat dobrze leży? (nie chwieje się)

☐ Sprawdzenie uszczelnień:
   ☐ Czy silikon wszędzie tam gdzie powinien?
   ☐ Czy zlew szczelny? (test wodą!)

☐ Czyszczenie blatu:
   ☐ Odkurz kurz z cięcia
   ☐ Przetrzyj mikrofibr + woda (bez chemii!)
   ☐ Wypoleruj do połysku

☐ Test wodą:
   ☐ Lej wodę na blat (sprawdź jak spływa)
   ☐ Sprawdź czy woda nie wnika pod panel ścienny
   ☐ Sprawdź szczelność zlewu (odkręć kurki!)
```

---

### 🔴 CO ROBIĆ GDY PĘKŁ BLAT? (Najgorszy scenariusz)

```
❌ Pęknięcie podczas cięcia/wiercenia:

☐ NATYCHMIAST przerwij pracę
☐ Zrób zdjęcia pęknięcia
☐ Sprawdź przyczynę:
   - Ostry kąt 90° (nie wywierciłeś narożników)? ← Najczęściej!
   - Za blisko krawędzi (<50mm)?
   - Zimny blat (nie odczekałeś aklimatyzacji)?

☐ Opcje naprawy:
   1. Jeśli mała szczelina (<2mm):
   ...
   2. Jeśli duża szczelina / złamanie:
      ...
      → Przełóż montaż o tydzień
      → Przeproś klienta (bądź szczery!)

☐ Jak tego uniknąć NASTĘPNYM RAZEM:
   → ZAWSZE wiercić narożniki 10mm!
   → ZAWSZE sprawdzać minimalne odległości!
   → ZAWSZE czekać na aklimatyzację!
```

---

### ⏱️ TIMELINE MONTAŻU BLATU (typowy)

```
08:00-08:30  Aklimatyzacja blatu + przygotowanie narzędzi
08:30-09:30  Pomiar, oznaczenie, cięcie blatu na długość
09:30-10:30  Wycięcie otworu pod zlew (OSTROŻNIE!)
10:30-11:00  Wycięcie otworu pod płytę indukcyjną
11:00-11:30  Montaż trawersów, klejenie blatu
11:30-12:00  Przerwa (klej twardnieje)
12:00-12:30  Montaż zlewu
12:30-13:00  Montaż panelu ściennego
13:00-13:30  Czyszczenie, kontrola
```
...
**CEL:** Bezkolizyjne osadzenie lodówki, zgranie fugi frontów, wentylacja.
...
→ Przy otwieraniu front wsuwa się DO ŚRODKA szafki o ~5mm
→ Uderza w korpus lodówki → WYRWIE front!

Zawias Blum 155°:
→ Front przy otwieraniu "ucieka" NA ZEWNĄTRZ
...
**CEL:** Montaż zmywarki z frontem meblowym, zawiasy ślizgowe, ochrona nad zmywarką.
...
## ✅ PLAYBOOK #13: FINALIZACJA I ODBIÓR Z KLIENTEM

**CEL:** Czyste zakończenie, edukacja klienta, zapewnienie gwarancji, płatność.
...
### 📋 KROK 2: Kontrola techniczna (30 min)
...
### 📄 KROK 4: Edukacja klienta (15 min)
...
- Przeciążenie szafek (>30kg na półkę)
...
### 📊 KROK 9: Analiza projektu (24h po zakończeniu)
...
## 📝 PODSUMOWANIE CAŁEGO SYSTEMU PLAYBOOKÓW

Stworzyłem dla Ciebie **13 gotowych playbooków** obejmujących:

1. ✅ Rozmowa kwalifikacyjna
2. ✅ Pomiar (z formularzem do wydruku!)
3. ✅ Projektowanie Corpus
4. ✅ Zamówienie CNC
5. ✅ Zamówienie okuć i akcesoriów
6. ✅ (Kontrola wbudowana w playbook #4 i #5)
7. ✅ (Przygotowanie do montażu - wbudowane)
8. ✅ (Montaż korpusów - do stworzenia w part 3)
9. ✅ Montaż blatu HPL (szczegółowy!)
10. ✅ Montaż lodówki w zabudowie
11. ✅ Montaż zmywarki
12. ✅ (LED - do stworzenia w part 3)
13. ✅ Finalizacja i odbiór

**Każdy playbook to gotowy checklist do wydruku i używania na budowie!**

Chcesz żebym:
- Dokończył brakujące playbooki (#8, #12)?
