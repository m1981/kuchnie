...
- **Base Decors:** The primary visual identifier (e.g., _K003 Gold Craft Oak_).
...
- **Smart Suggestion:** If the Front decor is available in `MFC`, the system prompts a 1-click button: _"Match Carcass to Front"_.
