...
from kitchen_cam.models import EdgeBand, EdgeSide, Panel, PanelRole
...
class TestEdgeBandingInCalculator:
    ...
    @pytest.fixture()
    def spec(self):
        from kitchen_cam.models import CorpusSpec
        return CorpusSpec(
            id="T",
            name="test",
    ...
    def test_side_panels_have_top_and_left_edges(self, spec):
        ...
        from kitchen_cam.panel_calculator import _side_panels
    ...
    def test_back_panel_has_no_edges(self, spec):
        ...
        from kitchen_cam.panel_calculator import _back_panel
    ...
    def test_door_fronts_have_all_edges(self, spec):
        ...
        from kitchen_cam.panel_calculator import _door_fronts
