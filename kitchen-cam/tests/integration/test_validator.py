...
from kitchen_cam.models import DrillFace, DrillPoint, DrillType, Panel, PanelRole
...
def test_validator_exists():
    ...
    from kitchen_cam.validator import validate_panels  # noqa: F401
...
def test_validation_result_model():
    ...
    from kitchen_cam.validator import ValidationResult
...
class TestEdgeClearance:
    ...
    def test_system32_respects_offset(self):
        ...
        from kitchen_cam.machining import SYSTEM32_OFFSET
        min_clearance = 5.0
...
class TestValidatePanelsFunction:
    ...
    def test_valid_panel_passes(self):
        ...
        from kitchen_cam.validator import validate_panels, ValidationResult
    ...
    def test_out_of_bounds_drill_fails(self):
        ...
        from kitchen_cam.validator import validate_panels
