...
> Generated: 2026-07-28T21:49:07+00:00
...
**Acceptance gauge (R7, all specs): 13/24 LIVE.** Denominator = pre-written intent, numerator = demonstrated fact; it can go DOWN when a commit stales a completion claim.
...
**Open 6 product / 8 process · closed 7d 1 product / 1 process (2 classified by keyword)**
...
| Signal | State |
|---|---|
| spec-health | 🟢 spec-health: 0 failure(s), 55 warning(s) across 17 spec(s) |
| doc-health | 🟢 doc-health: 0 failure(s) across 110 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 1 · live 105 · retracted 54 · unverified 4 |
