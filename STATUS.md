...
> Generated: 2026-08-03T22:34:39+00:00
...
- **3 retraction(s) ready** (human-only; every diverged claim's verdict names its live successor). Paste:

  ```
  for id in tr-657cc482 tr-88f12036 tr-54214e5f; do TRUTH_HUMAN=1 TRUTH_HUMAN_ACK=$id scripts/truth verdict $id retracted --basis "superseded; successor in verdict trail"; done
  ```
...
| doc-health | 🟢 doc-health: 0 failure(s) across 134 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 2 · diverged 3 · live 128 · retracted 77 · stale 7 · unverified 1 |
| verdict queue | 3 human (§ 2) + 0 verifier |
