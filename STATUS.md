...
> Generated: 2026-07-16T22:11:07+00:00

## Health

| Signal | State |
|---|---|
| spec-health | 🔴 spec-health: 15 failure(s), 44 warning(s) across 16 spec(s) |
...
| claims | cannot_verify 2 · diverged 4 · live 49 · retracted 29 · stale 25 · unverified 2 |
| verdict queue | 14 awaiting triage |
...
| — | wk-a898481e | DrawerBoxSpec parameter object: decompose_drawer_box (11/10 params) and make_runner_accessory (8) collapse their drawer-box arguments into one spec consumed by the DrawerSystem ABC, catalog decomposer and variant_derivation | HELD — tr-89acfc89 (stale) |
| — | wk-acc8e094 | validate_rows returns structured findings (gate id, severity, ref) consumed by buildability directly; strings become its display layer | HELD — tr-88fb2941 (stale) |
| — | wk-b669f4f5 | Split the ERP god-states: AdminState (36 methods) and KitchenState (32) — extract row-layout math into a testable core module, group setters into substates; add_module (12 params) gets a module spec | HELD — tr-89acfc89 (stale) |
...
Unmapped open bd issues (add to `docs/roadmap-map.csv`): kuchnie-8mw, kuchnie-9yz, kuchnie-b30, kuchnie-el6, kuchnie-hij, kuchnie-oqu, kuchnie-yvm
...
**⚠ capability cells citing non-live facts (re-verify or re-map):** dolna_legrabox: tr-8dfe366d, dolna_legrabox: tr-15d48651, dolna_legrabox: tr-3ef7b607, dolna_legrabox: tr-b485d74c, dolna_legrabox: tr-3bb325f8, dolna_narozna_slepa: tr-591aa208, gorna_drzwiowa: tr-3ef7b607
