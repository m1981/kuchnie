...
> Generated: 2026-07-29T09:31:40+00:00
...
**Acceptance gauge (R7, all specs): 15/32 LIVE.** Denominator = pre-written intent, numerator = demonstrated fact; it can go DOWN when a commit stales a completion claim.
...
- **5 retraction(s) ready** (human-only; every diverged claim's verdict names its live successor). Paste:
  ...
  ```
  for id in tr-b485d74c tr-fff10d41 tr-ecd97fee tr-c440ff7a tr-0e230136; do TRUTH_HUMAN=1 TRUTH_HUMAN_ACK=$id scripts/truth verdict $id retracted --basis "superseded; successor in verdict trail"; done
  ```
...
**Open 8 product / 10 process · closed 7d 2 product / 1 process (2 classified by keyword)**
...
| — | wk-cc39b1b0 | Survey pack: named ArtifactRef kinds + completeness checklist, 2->3 transition refuses an incomplete pack | live |
| — | wk-fc3aba75 | Widen the design-entry guard: a forward stage move crossing into 3_layout_design or beyond checks survey-pack completeness, closing the 1->3 skip bypass | live |
...
| Signal | State |
|---|---|
| spec-health | 🔴 spec-health: 4 failure(s), 55 warning(s) across 21 spec(s) |
| doc-health | 🟢 doc-health: 0 failure(s) across 115 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 1 · diverged 5 · live 109 · retracted 54 · unverified 4 |
| verdict queue | 5 human (§ 2) + 0 verifier |
| backward trace (R2) | TRACED 43 · MENTIONED 32 · DARK 0 |
| R4 tests | `scripts/test-health.sh` — cited ids swept at close |
| R7 acceptance | 15/32 LIVE (§ 1) |
| last exercise run | 2026-07-13T14:38:15+00:00 · Blender 5.1.2 · repo `7c42aed` · hb5 `1428e55` |

**Closed in 14 days: 27** — latest:
