...
> Generated: 2026-07-15T23:20:06+00:00

## Health

| Signal | State |
|---|---|
| spec-health | 🟢 spec-health: 0 failure(s), 40 warning(s) across 14 spec(s) |
| doc-health | 🟢 doc-health: 0 failure(s) across 96 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 1 · diverged 16 · live 42 · retracted 11 · stale 15 · unverified 6 |
| verdict queue | 25 awaiting triage |
| backward trace (R2) | TRACED 34 · MENTIONED 19 · DARK 22 (`scripts/coverage-audit.py`; DARK triage = product-owner verb) |
