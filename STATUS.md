...
> Generated: 2026-07-15T22:29:16+00:00

## Health

| Signal | State |
|---|---|
| spec-health | 🔴 spec-health: 4 failure(s), 39 warning(s) across 14 spec(s) |
| doc-health | 🟢 doc-health: 0 failure(s) across 95 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | diverged 17 · live 40 · retracted 8 · stale 18 · unverified 7 |
...
Unmapped open bd issues (add to `docs/roadmap-map.csv`): kuchnie-el6
...
**⚠ capability cells citing non-live facts (re-verify or re-map):** dolna_legrabox: tr-15d48651, dolna_legrabox: tr-3bb325f8
