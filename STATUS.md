wrote /Users/michal/PycharmProjects/kuchnie/STATUS.md
 any of his five moments (client call, session start, grooming, quality glance, retro) | Enables: answering each moment's question from one page instead of five commands | Update-trigger: GENERATED by `scripts/dashboard.py` — never hand-edit; freshness gated by `session-gates.d/30-dashboard-fresh.sh`

> Generated: 2026-07-14T22:55:39+00:00

## Health

| Signal | State |
|---|---|
| spec-health | 🟢 spec-health: 0 failure(s), 36 warning(s) across 13 spec(s) |
...
| claims | diverged 14 · live 30 · retracted 8 · stale 17 · unverified 7 |
