...
> Generated: 2026-07-16T10:40:01+00:00
...
| claims | cannot_verify 1 · diverged 16 · live 46 · retracted 11 · stale 15 · unverified 6 |
| verdict queue | 25 awaiting triage |
| backward trace (R2) | TRACED 37 · MENTIONED 32 · DARK 0 (`scripts/coverage-audit.py`; DARK triage = product-owner verb) |
...
|---|---|---|---|
| UC-2 | docs/specs/use-cases.md defines six actor-hats with goals, marks five use cases for full d… | LIVE | tr-a95ed226 (live) |
...
**Gauge: 3/3 acceptance items LIVE.** The denominator is intent (pre-written claims), the numerator is demonstrated fact — the gauge can go down when a commit stales a completion claim.
...
Unmapped open bd issues (add to `docs/roadmap-map.csv`): kuchnie-el6, kuchnie-oqu
