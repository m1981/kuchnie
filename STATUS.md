...
> Generated: 2026-07-14T14:06:36+00:00

## Health

| Signal | State |
|---|---|
| spec-health | 🔴 spec-health: 2 failure(s), 23 warning(s) across 13 spec(s) |
...
| claims | diverged 14 · live 30 · retracted 8 · stale 15 · unverified 7 |
...
| P1 | wk-81a47ab8 / kuchnie-5tt | Adapter extraction fidelity round 2: drawer stacks, corner cabinets, worktops from hb5 scenes | live |
...
| P2 | wk-89a668a2 / kuchnie-tai | Buildability verdict: ordered validation gate runner over the scattered checks (UC-2 step 5) | HELD — tr-00421995 (stale) |
...
flowchart LR
    ...
    subgraph s4 ["4. Decomposition"]
        ...
        kuchnie_8vv["P3 kuchnie-8vv<br/>Front margin shop setting (G12)"]
