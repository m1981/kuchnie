...
> Generated: 2026-07-16T21:52:17+00:00

## Health

| Signal | State |
|---|---|
| spec-health | 🔴 spec-health: 22 failure(s), 44 warning(s) across 16 spec(s) |
...
| claims | cannot_verify 2 · diverged 4 · live 46 · retracted 29 · stale 27 · unverified 1 |
| verdict queue | 16 awaiting triage |
| backward trace (R2) | TRACED 39 · MENTIONED 32 · DARK 0 (`scripts/coverage-audit.py`; DARK triage = product-owner verb) |
...
| P3 | wk-5cb8c45e / kuchnie-no6 | Delete or wire dead CabinetGeometry in construction.py | live |
...
| — | wk-9c99a7da | Break the kitchen-erp model-service import cycle: move BOM orchestration off the Project entity (generate_project_bom) into a service module | live |
...
| P2 | wk-6716e9c8 / kuchnie-58o | Acquire missing decor miniature images (90/148 decors, incl. all 35 wood decors) | HELD — tr-57424139 (stale) |
...
| — | wk-cd815fba | Extraction r3: front-height write-path translation (B5), NL/height-code derivation, verify material extraction against the decor-split e2e scene | HELD — tr-ef90fea5 (stale) |
...
Unmapped open bd issues (add to `docs/roadmap-map.csv`): kuchnie-8mw, kuchnie-9yz, kuchnie-el6, kuchnie-oqu, kuchnie-yed, kuchnie-yvm
