...
> Generated: 2026-08-01T14:45:15+00:00
...
|---|---|---|---|---|
| conformance-join | — | docs/specs/conformance-join.md is the Phase 1 umbrella spec of the two… | LIVE | tr-409f4aab (live ← tr-76876cfc) |
...
- **2 retraction(s) ready** (human-only; every diverged claim's verdict names its live successor). Paste:
  ...
  ```
  for id in tr-06522739 tr-7855c415; do TRUTH_HUMAN=1 TRUTH_HUMAN_ACK=$id scripts/truth verdict $id retracted --basis "superseded; successor in verdict trail"; done
  ```
...
**Open 5 product / 9 process · closed 7d 4 product / 3 process (5 classified by keyword)**
...
| claims | cannot_verify 1 · diverged 2 · live 120 · retracted 66 · stale 3 |
| verdict queue | 2 human (§ 2) + 1 verifier |
