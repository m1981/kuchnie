...
> Generated: 2026-07-17T22:34:20+00:00
...
**Acceptance gauge (R7, all specs): 13/20 LIVE.** Denominator = pre-written intent, numerator = demonstrated fact; it can go DOWN when a commit stales a completion claim.
...
- **1 retraction(s) ready** (human-only; every diverged claim's verdict names its live successor). Paste:

  ```
  for id in tr-88fb2941; do TRUTH_HUMAN=1 TRUTH_HUMAN_ACK=$id scripts/truth verdict $id retracted --basis "superseded; successor in verdict trail"; done
  ```
...
- **5 claim(s) for an agent verifier** (not you — but only you start sessions). Move the needle: say *“dispatch a verifier sweep”*.

## 3 · What's next — ready lane, product | process

**Open 6 product / 6 process · closed 7d 23 product / 30 process (36 classified by keyword) ⚠ swing back to product**
...
| Signal | State |
|---|---|
| spec-health | 🟢 spec-health: 0 failure(s), 51 warning(s) across 16 spec(s) |
