...
> Generated: 2026-07-17T20:35:03+00:00
...
| purchasing-variants | — | Offers record against variants with optional line itemization, archive… | FILED | tr-c87a68f9 (stale) |
...
- **1 retraction(s) ready** (human-only; every diverged claim's verdict names its live successor). Paste:
  ...
  ```
  for id in tr-d59194ea; do TRUTH_HUMAN=1 TRUTH_HUMAN_ACK=$id scripts/truth verdict $id retracted --basis "superseded; successor in verdict trail"; done
  ```
...
**Open 7 product / 5 process · closed 7d 21 product / 26 process (33 classified by keyword) ⚠ swing back to product**
...
| Signal | State |
|---|---|
| spec-health | 🔴 spec-health: 1 failure(s), 46 warning(s) across 16 spec(s) |
...
| claims | cannot_verify 2 · diverged 1 · live 78 · retracted 42 · stale 1 · unverified 3 |
