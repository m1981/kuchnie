...
> Generated: 2026-07-16T23:53:49+00:00
...
| purchasing-variants | — | Supplier price rows enter through the landing schema with verbatim sou… | LIVE | tr-747adf10 (live) |
...
**Open 6 product / 5 process · closed 7d 20 product / 23 process (30 classified by keyword) ⚠ swing back to product**
...
**⚠ unmapped open bd issues** (both views above lie by omission until mapped): kuchnie-h9h — move the needle: add a row with stage+uc+axis to `docs/roadmap-map.csv`.
...
| claims | cannot_verify 2 · live 74 · retracted 39 · stale 1 · unverified 3 |
