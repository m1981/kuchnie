...
> Generated: 2026-08-02T11:52:08+00:00
...
| height-parameter-set | — | validate_rows consumes a supplied height parameter set and G1 reports … | FILED | tr-0d819e45 (stale) |
...
**Open 5 product / 9 process · closed 7d 5 product / 3 process (5 classified by keyword)**
...
**⚠ unmapped open bd issues** (both views above lie by omission until mapped): kuchnie-05p, kuchnie-27b, kuchnie-33x, kuchnie-4q8, kuchnie-5q3, kuchnie-8be, kuchnie-8ky, kuchnie-c6z, kuchnie-h45, kuchnie-lm8, kuchnie-qrs, kuchnie-ubc.1, kuchnie-zae — move the needle: add a row with stage+uc+axis to `docs/roadmap-map.csv`.
...
| doc-health | 🟢 doc-health: 0 failure(s) across 125 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 1 · diverged 5 · live 136 · retracted 66 · stale 3 |
| verdict queue | 5 human (§ 2) + 1 verifier |
| backward trace (R2) | TRACED 49 · MENTIONED 30 · DARK 0 |
