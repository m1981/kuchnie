...
> Generated: 2026-07-17T21:15:09+00:00
...
**Acceptance gauge (R7, all specs): 12/20 LIVE.** Denominator = pre-written intent, numerator = demonstrated fact; it can go DOWN when a commit stales a completion claim.
...
- **2 retraction(s) ready** (human-only; every diverged claim's verdict names its live successor). Paste:
  ...
  ```
  for id in tr-0d0b090b tr-6aea682d; do TRUTH_HUMAN=1 TRUTH_HUMAN_ACK=$id scripts/truth verdict $id retracted --basis "superseded; successor in verdict trail"; done
  ```
...
**Open 7 product / 5 process · closed 7d 21 product / 29 process (36 classified by keyword) ⚠ swing back to product**
...
| claims | cannot_verify 2 · diverged 2 · live 79 · retracted 43 · unverified 4 |
