...
> Generated: 2026-08-01T15:20:31+00:00
...
**Acceptance gauge (R7, all specs): 21/34 LIVE.** Denominator = pre-written intent, numerator = demonstrated fact; it can go DOWN when a commit stales a completion claim.
...
| doc-health | 🟢 doc-health: 0 failure(s) across 118 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 1 · diverged 4 · live 123 · retracted 66 |
