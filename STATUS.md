...
> Generated: 2026-07-17T00:30:06+00:00
...
| purchasing-variants | — | Supplier price rows enter through the landing schema with verbatim sou… | FILED | tr-d0610cb4 (diverged) |
...
- **1 retraction(s) ready** (human-only; every diverged claim's verdict names its live successor). Paste:
  ...
  ```
  for id in tr-d0610cb4; do TRUTH_HUMAN=1 TRUTH_HUMAN_ACK=$id scripts/truth verdict $id retracted --basis "superseded; successor in verdict trail"; done
  ```
...
**Open 7 product / 5 process · closed 7d 21 product / 23 process (31 classified by keyword) ⚠ swing back to product**
...
| — | wk-b440d8bb | Consolidate hardware sources: rules-engine tags (BOMGenerator) vs decomposer accessories (variant lines) - pick one hardware source, make the other a view | warn: tr-60c60f8b: premise not yet independently verified |
...
**⚠ unmapped open bd issues** (both views above lie by omission until mapped): kuchnie-b2u, kuchnie-bbf, kuchnie-h9h, kuchnie-nu0 — move the needle: add a row with stage+uc+axis to `docs/roadmap-map.csv`.
...
| claims | cannot_verify 2 · diverged 1 · live 75 · retracted 40 · unverified 4 |
