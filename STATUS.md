...
> Generated: 2026-08-03T10:03:45+00:00
...
- **2 claim(s) for an agent verifier** (not you — but only you start sessions). Move the needle: say *“dispatch a verifier sweep”*.

## 3 · What's next — ready lane, product | process

**Open 11 product / 9 process · closed 7d 5 product / 3 process (5 classified by keyword)**
...
| doc-health | 🟢 doc-health: 0 failure(s) across 131 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 2 · live 131 · retracted 75 · stale 8 · unverified 1 |
