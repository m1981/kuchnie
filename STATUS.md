...
> Generated: 2026-08-02T11:40:32+00:00
...
**Acceptance gauge (R7, all specs): 23/34 LIVE.** Denominator = pre-written intent, numerator = demonstrated fact; it can go DOWN when a commit stales a completion claim.
...
**⚠ unmapped open bd issues** (both views above lie by omission until mapped): kuchnie-019, kuchnie-05p, kuchnie-26s, kuchnie-27b, kuchnie-33x, kuchnie-4q8, kuchnie-5q3, kuchnie-5un, kuchnie-8ky, kuchnie-c6z, kuchnie-h45, kuchnie-lh2, kuchnie-lm8, kuchnie-ubc.1, kuchnie-zae — move the needle: add a row with stage+uc+axis to `docs/roadmap-map.csv`.

## 5 · Is the machine OK? — regime health

| Signal | State |
|---|---|
| spec-health | 🟢 spec-health: 0 failure(s), 295 warning(s) across 105 spec(s) |
| doc-health | 🟢 doc-health: 0 failure(s) across 124 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | cannot_verify 1 · diverged 5 · live 138 · retracted 66 |
| verdict queue | 5 human (§ 2) + 0 verifier |
| backward trace (R2) | TRACED 47 · MENTIONED 30 · DARK 0 |
| R4 tests | `scripts/test-health.sh` — cited ids swept at close |
| R7 acceptance | 23/34 LIVE (§ 1) |
