...
> Generated: 2026-07-14T12:03:47+00:00

## Health

| Signal | State |
|---|---|
| spec-health | 🟢 spec-health: 0 failure(s), 23 warning(s) across 13 spec(s) |
| doc-health | 🟢 doc-health: 0 failure(s) across 86 live doc(s) |
| flagship baseline | guarded by `scripts/exercise-gate.sh` (runs at session-close) |
| claims | diverged 14 · live 31 · retracted 8 · stale 11 · unverified 7 |
...
flowchart LR
    ...
    subgraph s4 ["4. Decomposition"]
        kuchnie_92j["P2 kuchnie-92j<br/>G8 drawer-order semantics (scrap-risk)"]
