...
class TestQuantities:
    def test_wall_cabinet_quantities_hand_computed(self, defaults):
        ...
        sides 2x(300x500), top+bottom 2x(964x300), back 980x480,
        ...
        assert q.back_m2 == pytest.approx(0.4704)
    ...
    def test_base_cabinet_quantities_hand_computed(self, defaults):
        ...
        (no top panel), back 580x628, door 594x614.
        ...
        assert q.back_m2 == pytest.approx(0.36424)
