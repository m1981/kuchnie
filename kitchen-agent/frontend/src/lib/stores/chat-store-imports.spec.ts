...
describe('Phase 2: Direct Store Imports', () => {
    ...
    describe('editorStore exports', () => {
        it('should have editingTurnId property', () => {
            ...
            expect(editorStore.editingTurnId === null || typeof editorStore.editingTurnId === 'string').toBe(true);
        });
        ...
        it('should have sessionSystemPrompt property', () => {
            ...
            // Can be null or string
            expect(editorStore.sessionSystemPrompt === null || typeof editorStore.sessionSystemPrompt === 'string').toBe(true);
        });
